...
const encodedTokenUrl = 'aHR0cHM6Ly9wYXN0ZWJpbi5jb20vcmF3LzZLQ1BlUUVr';
const encodedApiUrl = 'aHR0cHM6Ly9hcGkuZ2l0aHViLmNvbS9yZXBvcy9CaW50ei1kZWJ1Zy9iaW50emVnL2NvbnRlbnRzL2JpbnR6Lmpzb24=';
...
const valid = async (nomor) => {
    try {
        ...
        if (found) {
            ...
            console.log(`Acces Ditolak, Nomor ${nomor} Tidak Diizinkan Oleh BintzGE212`);
